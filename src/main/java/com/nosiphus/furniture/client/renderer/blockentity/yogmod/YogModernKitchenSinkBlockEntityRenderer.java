...
public class YogModernKitchenSinkBlockEntityRenderer implements BlockEntityRenderer<YogModernKitchenSinkBlockEntity>
{

    public YogModernKitchenSinkBlockEntityRenderer(BlockEntityRendererProvider.Context context) {}

    @Override
    public void render(YogModernKitchenSinkBlockEntity tileEntity, float partialTicks, PoseStack poseStack, MultiBufferSource source, int light, int overlay)
    {
        poseStack.pushPose();
    ...
    private void drawFluid(YogModernKitchenSinkBlockEntity te, PoseStack poseStack, MultiBufferSource source, float x, float y, float z, float width, float height, float depth, int light)
    {
