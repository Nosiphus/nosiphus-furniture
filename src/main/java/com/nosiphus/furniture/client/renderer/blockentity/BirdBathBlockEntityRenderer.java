...
public class BirdBathBlockEntityRenderer implements BlockEntityRenderer<BirdBathBlockEntity> {
    ...
    @Override
    public void render(BirdBathBlockEntity tileEntity, float partialTicks, PoseStack poseStack, MultiBufferSource source, int light, int i1)
    {
        poseStack.pushPose();
    ...
    private void drawFluid(BirdBathBlockEntity te, PoseStack poseStack, MultiBufferSource source, float x, float y, float z, float width, float height, float depth, int light) {
