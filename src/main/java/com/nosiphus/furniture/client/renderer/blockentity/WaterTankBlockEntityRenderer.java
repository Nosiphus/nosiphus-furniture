...
public class WaterTankBlockEntityRenderer implements BlockEntityRenderer<WaterTankBlockEntity> {
    ...
    public void render(WaterTankBlockEntity tileEntity, float partialTicks, PoseStack poseStack, MultiBufferSource source, int light, int i1)
    {
        ...
        poseStack.translate(-0.5, -0.5, -0.5);
        this.drawFluid(tileEntity, poseStack, source, 1.8F * 0.0625F, 7.0F * 0.0625F, 1.8F * 0.0625F, 12.4F * 0.0625F, 10.0F * 0.0625F, 12.4F * 0.0625F, light);
        poseStack.popPose();
    }

    private void drawFluid(WaterTankBlockEntity te, PoseStack poseStack, MultiBufferSource source, float x, float y, float z, float width, float height, float depth, int light) {
