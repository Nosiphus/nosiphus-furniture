...
//this class is used as a starting point when adding new blocks. It is not used as an actual block.
public class ReferenceBlock extends FurnitureHorizontalBlock
{
    public final ImmutableMap<BlockState, VoxelShape> SHAPES;

    public ReferenceBlock(Properties properties)
    {
        super(properties);
