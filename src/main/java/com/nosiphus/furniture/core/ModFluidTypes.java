...
public class ModFluidTypes {
    ...
    public static final ResourceLocation SOAP_OVERLAY = new ResourceLocation(NosiphusFurnitureMod.MOD_ID, "misc/soapy_water");
    public static final ResourceLocation SUPER_SOAP_OVERLAY = new ResourceLocation(NosiphusFurnitureMod.MOD_ID, "misc/super_soapy_water");
    ...
    private static RegistryObject<FluidType> registerSuperSoap(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL, WATER_FLOW, SUPER_SOAP_OVERLAY,
                0xA1C5FF1F, new Vector3f(197f / 255f, 255f / 255f, 31f / 255f), properties));
    }
